...
export default class BreadcrumbView extends PureComponent {
  ...
  conversionFromLocation = (routerLocation, breadcrumbNameMap) => {
    ...
    const extraBreadcrumbItems = pathSnippets.map((url, index) => {
      ...
      let name = '';
      if (currentBreadcrumb.iframe) {
        name = currentBreadcrumb.name;
      } else {
        name = itemRender ? itemRender(currentBreadcrumb) : currentBreadcrumb.name;
      }
  ...
  conversionBreadcrumbList = () => {
    ...
    const breadcrumbNameMapFinish = Object.assign({}, breadcrumbNameMap, this.props.urlDatas);
    ...
    if (routerLocation && routerLocation.pathname) {
      return this.conversionFromLocation(routerLocation, breadcrumbNameMapFinish);
    }
    return null;
  };
