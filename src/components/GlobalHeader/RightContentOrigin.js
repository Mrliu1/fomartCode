...
export default class GlobalHeaderRight extends PureComponent {
  ...
  render() {
    ...
    const url = `https://euas.icarbonx.cn/server/logout?&redirect_url=${redi_url}`;
    const menu = (
      <Menu className={styles.menu} selectedKeys={[]} onClick={onMenuClick}>
        ...
        <Menu.Item key="logout">
          <span>
            <Icon type="logout" />
            <a href={`https://euas.icarbonx.cn/server/logout?&redirect_url=${location.href}`}>
              <FormattedMessage id="menu.account.logout" defaultMessage="Login Out" />
            </a>
          </span>
        </Menu.Item>
      </Menu>
